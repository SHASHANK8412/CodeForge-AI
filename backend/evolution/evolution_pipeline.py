...
class EvolutionPipeline:
    ...
    def _write_report_file(self, filename: str, content: str) -> None:
        ...
        try:
            ...
            with open(workspace_reports_dir / filename, "w", encoding="utf-8") as f:
                f.write(content)
        except Exception as e:
            _logger.error(f"Failed to copy report to workspace folder: {str(e)}")
    ...
    def _save_evolution_log(self, entry: Dict[str, Any]) -> None:
        ...
        try:
            ...
            try:
                workspace_reports_dir = Path(__file__).resolve().parent.parent / "reports"
                workspace_reports_dir.mkdir(parents=True, exist_ok=True)
                with open(workspace_reports_dir / "evolution_log.json", "w", encoding="utf-8") as f:
                    json.dump(history, f, indent=2)
            except Exception as e:
                pass
        except Exception as e:
...
"""
        self._write_report_file("project_summary.md", summary_content)
...
"""
        self._write_report_file("analysis_report.md", analysis_content)
...
"""
        self._write_report_file("architecture_review.md", arch_content)
...
"""
        self._write_report_file("security_report.md", sec_content)
...
"""
        self._write_report_file("performance_report.md", perf_content)
...
"""
        self._write_report_file("database_review.md", db_content)
...
"""
        self._write_report_file("frontend_review.md", fe_content)
...
"""
        self._write_report_file("backend_review.md", be_content)
...
"""
        self._write_report_file("testing_report.md", test_content)
...
"""
        self._write_report_file("devops_report.md", do_content)
...
"""
        self._write_report_file("improvement_plan.md", plan_content)
